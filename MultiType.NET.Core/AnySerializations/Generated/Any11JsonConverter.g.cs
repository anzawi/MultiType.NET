...
/// <summary>
/// A custom JSON converter for serializing and deserializing instances of the <see cref = "MultiType.NET.Core.Anys.Generated.Any{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11}"/> type.
...
public class AnyJsonConverter<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : JsonConverter<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>
{
    /// <summary>
    ...
    // Reads and converts the JSON to a Any{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11} object.
    ...
    /// <returns>A Any{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11} object converted from the JSON.</returns>
    /// <exception cref = "JsonException">Thrown if the JSON is invalid or necessary properties are missing.</exception>
    public override global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    /// Writes the JSON representation of the specified Any{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11} object.
    /// <param name = "writer">
    /// The Utf8JsonWriter to write the JSON data.
    /// </param>
    /// <param name = "value">
    /// The Any{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11} object to write.
    /// </param>
    /// <param name = "options">
    /// The JsonSerializerOptions to use for serialization.
    /// </param>
    public override void Write(Utf8JsonWriter writer, global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> value, JsonSerializerOptions options)
    {
        writer.WriteStartObject();
        value.Match(_ => writer.WriteNumber(TypeDiscriminator, 1), _ => writer.WriteNumber(TypeDiscriminator, 2), _ => writer.WriteNumber(TypeDiscriminator, 3), _ => writer.WriteNumber(TypeDiscriminator, 4), _ => writer.WriteNumber(TypeDiscriminator, 5), _ => writer.WriteNumber(TypeDiscriminator, 6), _ => writer.WriteNumber(TypeDiscriminator, 7), _ => writer.WriteNumber(TypeDiscriminator, 8), _ => writer.WriteNumber(TypeDiscriminator, 9), _ => writer.WriteNumber(TypeDiscriminator, 10), _ => writer.WriteNumber(TypeDiscriminator, 11));
