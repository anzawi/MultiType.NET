...
public class AnyJsonConverter<T1, T2, T3, T4> : JsonConverter<Any<T1, T2, T3, T4>>
{
    /// <summary>
    ...
    public override Any<T1, T2, T3, T4> Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    /// </param>
    public override void Write(Utf8JsonWriter writer, Any<T1, T2, T3, T4> value, JsonSerializerOptions options)
    {
