...
public class AnyJsonConverter<T1, T2, T3, T4, T5, T6> : JsonConverter<Any<T1, T2, T3, T4, T5, T6>>
{
    /// <summary>
    ...
    public override Any<T1, T2, T3, T4, T5, T6> Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    /// </param>
    public override void Write(Utf8JsonWriter writer, Any<T1, T2, T3, T4, T5, T6> value, JsonSerializerOptions options)
    {
