...
public readonly struct Any<T1, T2, T3> : global::MultiType.NET.Core.IAny
{
    ...
    public bool Is<T>() => (typeof(T) == typeof(T1) && TypeIndex == 1) || (typeof(T) == typeof(T2) && TypeIndex == 2) || (typeof(T) == typeof(T3) && TypeIndex == 3);
    /// <inheritdoc/>
    public T As<T>()
    {
        if (Is<T>())
            return (T)Value!;
        throw new InvalidCastException($"Type {typeof(T).Name} is not stored in this Any<{typeof(T1).Name}, {typeof(T2).Name}, {typeof(T3).Name}>.");
    }
    ...
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Any<T1, T2, T3> From(object? value)
    {
        return value switch
        {
            T1 v1 => new Any<T1, T2, T3>(v1),
            T2 v2 => new Any<T1, T2, T3>(v2),
            T3 v3 => new Any<T1, T2, T3>(v3),
            _ => throw new InvalidCastException($"Cannot cast {value?.GetType().Name ?? "null"} to Any of ({typeof(T1).Name}, {typeof(T2).Name}, {typeof(T3).Name})")};
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryFrom(object? value, out Any<T1, T2, T3> result)
    {
        switch (value)
        {
            case T1 v1:
                result = new Any<T1, T2, T3>(v1);
                return true;
            case T2 v2:
                result = new Any<T1, T2, T3>(v2);
                return true;
            case T3 v3:
                result = new Any<T1, T2, T3>(v3);
                return true;
            default:
                result = default;
                return false;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Any<T1, T2, T3> FromT1(T1? value)
    {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Any<T1, T2, T3> FromT2(T2? value)
    {
        return new Any<T1, T2, T3>(value);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Any<T1, T2, T3> FromT3(T3? value)
    {
        return new Any<T1, T2, T3>(value);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Any<T1, T2, T3>(T1? v) => new(v);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Any<T1, T2, T3>(T2? v) => new(v);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Any<T1, T2, T3>(T3? v) => new(v);
    /// <summary>
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> other)
            return false;
    ...
    public static bool operator ==(global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> left, global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> right) => left.Equals(right);
    public static bool operator !=(global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> left, global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> right) => !left.Equals(right);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Match([MaybeNull] Action<T1> case1, [MaybeNull] Action<T2> case2, [MaybeNull] Action<T3> case3)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult? TryMatch<TResult>(Func<T1, TResult>? case1 = null, Func<T2, TResult>? case2 = null, Func<T3, TResult>? case3 = null)
    {
        return this.TypeIndex switch
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void TryMatch([MaybeNull] Action<T1>? case1 = null, [MaybeNull] Action<T2>? case2 = null, [MaybeNull] Action<T3>? case3 = null)
    {
        switch (this.TypeIndex)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T1 GetT1(out global::MultiType.NET.Core.Anys.Generated.Any<T2, T3> remainder)
    {
        remainder = TypeIndex switch
        {
            2 => global::MultiType.NET.Core.Anys.Generated.Any<T2, T3>.From((T2)Value!),
            3 => global::MultiType.NET.Core.Anys.Generated.Any<T2, T3>.From((T3)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T2 GetT2(out global::MultiType.NET.Core.Anys.Generated.Any<T1, T3> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T3>.From((T1)Value!),
            3 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T3>.From((T3)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T3 GetT3(out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2>.From((T1)Value!),
            2 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2>.From((T2)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT1([MaybeNull] out T1 value, out global::MultiType.NET.Core.Anys.Generated.Any<T2, T3> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 2 && Value is T2 t2)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T2, T3>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T2, T3>.From(t3);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT2([MaybeNull] out T2 value, out global::MultiType.NET.Core.Anys.Generated.Any<T1, T3> remainder)
    {
        value = default;
        remainder = default;
        if (TypeIndex == 2 && Value is T2 t2)
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T3>.From(t1);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T3>.From(t3);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT3([MaybeNull] out T3 value, out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2>.From(t2);
        return false;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult Map<TResult>(Func<T1, TResult> map1, Func<T2, TResult> map2, Func<T3, TResult> map3)
    {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public global::MultiType.NET.Core.Anys.Generated.Any<TResult1, TResult2, TResult3> MapAny<TResult1, TResult2, TResult3>(Func<T1, TResult1> map1, Func<T2, TResult2> map2, Func<T3, TResult3> map3)
    {
        return TypeIndex switch
        {
            1when Value is T1 v1 => map1(v1),
    ...
    /// </summary>
    public async Task<TResult> MapAsync<TResult>(Func<T1, Task<TResult>> map1, Func<T2, Task<TResult>> map2, Func<T3, Task<TResult>> map3)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult MapOrDefault<TResult>(Func<T1, TResult> map1, Func<T2, TResult> map2, Func<T3, TResult> map3, TResult defaultValue = default !)
    {
        if (IsNull)
            return defaultValue;
        return TypeIndex switch
    ...
    /// </summary>
    public TResult MapSafe<TResult>(Func<T1, TResult> map1, Func<T2, TResult> map2, Func<T3, TResult> map3, Func<Exception, TResult> errorHandler)
    {
        try
        {
            return TypeIndex switch
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult MapWhere<TResult>(Func<T1, bool> predicate1, Func<T1, TResult> map1, Func<T2, bool> predicate2, Func<T2, TResult> map2, Func<T3, bool> predicate3, Func<T3, TResult> map3, TResult defaultValue = default !)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult MapWithContext<TResult>(Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>, T1, TResult> map1, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>, T2, TResult> map2, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>, T3, TResult> map3)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    public TResult Select<TResult>(Func<T1, TResult> selector1, Func<T2, TResult> selector2, Func<T3, TResult> selector3)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    public TResult SelectOrDefault<TResult>(Func<T1, TResult> selector1, Func<T2, TResult> selector2, Func<T3, TResult> selector3, TResult defaultValue = default !)
    {
        try
        {
            return Select(selector1, selector2, selector3);
        }
        catch
        {
            return defaultValue;
    ...
    /// </summary>
    public TResult? TrySelect<TResult>(Func<T1, TResult> selector1, Func<T2, TResult> selector2, Func<T3, TResult> selector3)
    {
    ...
    /// </summary>
    public TResult SelectWithContext<TResult>(Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>, T1, TResult> selector1, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>, T2, TResult> selector2, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>, T3, TResult> selector3)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    public TResult SelectWhere<TResult>(Func<T1, bool> predicate1, Func<T1, TResult> selector1, Func<T2, bool> predicate2, Func<T2, TResult> selector2, Func<T3, bool> predicate3, Func<T3, TResult> selector3, TResult defaultValue = default !)
    {
    ...
    /// </summary>
    public async Task<TResult> SelectAsync<TResult>(Func<T1, Task<TResult>> selector1, Func<T2, Task<TResult>> selector2, Func<T3, Task<TResult>> selector3)
    {
    ...
    /// </summary>
    public async Task<TResult> SelectAsyncOrDefault<TResult>(Func<T1, Task<TResult>> selector1, Func<T2, Task<TResult>> selector2, Func<T3, Task<TResult>> selector3, TResult defaultValue = default !)
    {
        try
        {
            return await SelectAsync(selector1, selector2, selector3);
        }
        catch
        {
            return defaultValue;
    ...
    /// </summary>
    public async Task SwitchAsync(Func<T1, Task> case1, Func<T2, Task> case2, Func<T3, Task> case3)
    {
        switch (TypeIndex)
        {
            case 1when Value is T1 v1:
    ...
    /// </summary>
    public void SwitchOrDefault(Action<T1> case1, Action<T2> case2, Action<T3> case3, Action fallback)
    {
        switch (TypeIndex)
        {
            case 1when Value is T1 v1:
    ...
    public static bool TryParse(string input, IFormatProvider? _, out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> result)
    {
        try
        {
