...
public readonly struct Any<T1, T2, T3> : IAny
{
    ...
    public T As<T>()
    {
        if (typeof(T) == typeof(T1) && TypeIndex == 1 || typeof(T) == typeof(T2) && TypeIndex == 2 || typeof(T) == typeof(T3) && TypeIndex == 3)
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Any<T1, T2, T3> other)
            return false;
    ...
    public static bool operator ==(Any<T1, T2, T3> left, Any<T1, T2, T3> right) => left.Equals(right);
    public static bool operator !=(Any<T1, T2, T3> left, Any<T1, T2, T3> right) => !left.Equals(right);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void TryMatch(Action<T1?>? case1 = null, Action<T2?>? case2 = null, Action<T3?>? case3 = null)
    {
        switch (this.TypeIndex)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T1 GetT1(out Any<T2, T3> remainder)
    {
        remainder = TypeIndex switch
        {
            2 => Any<T2, T3>.From((T2)Value!),
            3 => Any<T2, T3>.From((T3)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T2 GetT2(out Any<T1, T3> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T3>.From((T1)Value!),
            3 => Any<T1, T3>.From((T3)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T3 GetT3(out Any<T1, T2> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T2>.From((T1)Value!),
            2 => Any<T1, T2>.From((T2)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT1(out T1? value, out Any<T2, T3> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T2, T3>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T2, T3>.From(t3);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT2(out T2? value, out Any<T1, T3> remainder)
    {
        value = default;
        remainder = default;
        if (TypeIndex == 2 && Value is T2 t2)
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T3>.From(t1);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T1, T3>.From(t3);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT3(out T3? value, out Any<T1, T2> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T2>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T1, T2>.From(t2);
        return false;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Any<TResult1, TResult2, TResult3> MapAny<TResult1, TResult2, TResult3>(Func<T1, TResult1> map1, Func<T2, TResult2> map2, Func<T3, TResult3> map3)
    {
        return TypeIndex switch
        {
            1when Value is T1 v1 => map1(v1),
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult MapWithContext<TResult>(Func<Any<T1, T2, T3>, T1, TResult> map1, Func<Any<T1, T2, T3>, T2, TResult> map2, Func<Any<T1, T2, T3>, T3, TResult> map3)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    public TResult SelectWithContext<TResult>(Func<Any<T1, T2, T3>, T1, TResult> selector1, Func<Any<T1, T2, T3>, T2, TResult> selector2, Func<Any<T1, T2, T3>, T3, TResult> selector3)
    {
        return TypeIndex switch
        {
    ...
    /*
    public static bool TryParse(string? input, IFormatProvider? _, out Any<T1, T2, T3> result)
    {
        try
        {
            object? raw = input;
            ...
            {
                result = From((T1)(object)input!);
                return true;
            }

            var t1 = System.Text.Json.JsonSerializer.Deserialize<T1>(System.Text.Json.JsonSerializer.Serialize(input));
            if (t1 is not null)
            {
                result = new(t1);
                return true;
            ...
            // Try T2
            var t2 = System.Text.Json.JsonSerializer.Deserialize<T2>(System.Text.Json.JsonSerializer.Serialize(input));
            if (t2 is not null)
            {
                result = new(t2);
                return true;
