...
public readonly struct Any<T1, T2, T3, T4> : global::MultiType.NET.Core.IAny
{
    ...
    public bool Is<T>() => (typeof(T) == typeof(T1) && TypeIndex == 1) || (typeof(T) == typeof(T2) && TypeIndex == 2) || (typeof(T) == typeof(T3) && TypeIndex == 3) || (typeof(T) == typeof(T4) && TypeIndex == 4);
    /// <inheritdoc/>
    public T As<T>()
    {
        if (Is<T>())
            return (T)Value!;
        throw new InvalidCastException($"Type {typeof(T).Name} is not stored in this Any<{typeof(T1).Name}, {typeof(T2).Name}, {typeof(T3).Name}, {typeof(T4).Name}>.");
    }
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4> other)
            return false;
    ...
    public static bool operator ==(global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4> left, global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4> right) => left.Equals(right);
    public static bool operator !=(global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4> left, global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4> right) => !left.Equals(right);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Match([MaybeNull] Action<T1> case1, [MaybeNull] Action<T2> case2, [MaybeNull] Action<T3> case3, [MaybeNull] Action<T4> case4)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void TryMatch([MaybeNull] Action<T1>? case1 = null, [MaybeNull] Action<T2>? case2 = null, [MaybeNull] Action<T3>? case3 = null, [MaybeNull] Action<T4>? case4 = null)
    {
        switch (this.TypeIndex)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T1 GetT1(out global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4> remainder)
    {
        remainder = TypeIndex switch
        {
            2 => global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4>.From((T2)Value!),
            3 => global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4>.From((T3)Value!),
            4 => global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4>.From((T4)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T2 GetT2(out global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4>.From((T1)Value!),
            3 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4>.From((T3)Value!),
            4 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4>.From((T4)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T3 GetT3(out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4>.From((T1)Value!),
            2 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4>.From((T2)Value!),
            4 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4>.From((T4)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T4 GetT4(out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>.From((T1)Value!),
            2 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>.From((T2)Value!),
            3 => global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>.From((T3)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT1([MaybeNull] out T1 value, out global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 2 && Value is T2 t2)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4>.From(t3);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T2, T3, T4>.From(t4);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT2([MaybeNull] out T2 value, out global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4> remainder)
    {
        value = default;
        remainder = default;
        if (TypeIndex == 2 && Value is T2 t2)
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4>.From(t1);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4>.From(t3);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T3, T4>.From(t4);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT3([MaybeNull] out T3 value, out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4>.From(t2);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T4>.From(t4);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT4([MaybeNull] out T4 value, out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3>.From(t3);
        return false;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public global::MultiType.NET.Core.Anys.Generated.Any<TResult1, TResult2, TResult3, TResult4> MapAny<TResult1, TResult2, TResult3, TResult4>(Func<T1, TResult1> map1, Func<T2, TResult2> map2, Func<T3, TResult3> map3, Func<T4, TResult4> map4)
    {
        return TypeIndex switch
        {
            1when Value is T1 v1 => map1(v1),
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult MapWithContext<TResult>(Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T1, TResult> map1, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T2, TResult> map2, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T3, TResult> map3, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T4, TResult> map4)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    public TResult SelectWithContext<TResult>(Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T1, TResult> selector1, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T2, TResult> selector2, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T3, TResult> selector3, Func<global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4>, T4, TResult> selector4)
    {
        return TypeIndex switch
        {
    ...
    public static bool TryParse(string input, IFormatProvider? _, out global::MultiType.NET.Core.Anys.Generated.Any<T1, T2, T3, T4> result)
    {
        try
        {
