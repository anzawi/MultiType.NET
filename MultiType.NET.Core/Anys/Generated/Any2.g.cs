...
//     Generated: 2025-06-11 03:45:38 UTC
//
...
public readonly struct Any<T1, T2> : IAny
{
    ...
    public T As<T>()
    {
        if (typeof(T) == typeof(T1) && TypeIndex == 1 || typeof(T) == typeof(T2) && TypeIndex == 2)
        {
    ...
    public static bool operator ==(Any<T1, T2> left, Any<T1, T2> right) => left.Equals(right);
    public static bool operator !=(Any<T1, T2> left, Any<T1, T2> right) => !left.Equals(right);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void TryMatch(Action<T1?>? case1 = null, Action<T2?>? case2 = null)
    {
        switch (this.TypeIndex)
        {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Any<TResult1, TResult2> MapAny<TResult1, TResult2>(Func<T1, TResult1> map1, Func<T2, TResult2> map2)
    {
        return TypeIndex switch
        {
            1when Value is T1 v1 => map1(v1),
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult MapWithContext<TResult>(Func<Any<T1, T2>, T1, TResult> map1, Func<Any<T1, T2>, T2, TResult> map2)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    public TResult SelectWithContext<TResult>(Func<Any<T1, T2>, T1, TResult> selector1, Func<Any<T1, T2>, T2, TResult> selector2)
    {
        return TypeIndex switch
        {
