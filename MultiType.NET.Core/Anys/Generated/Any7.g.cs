...
public readonly struct Any<T1, T2, T3, T4, T5, T6, T7> : IAny
{
    ...
    public T As<T>()
    {
        if (typeof(T) == typeof(T1) && TypeIndex == 1 || typeof(T) == typeof(T2) && TypeIndex == 2 || typeof(T) == typeof(T3) && TypeIndex == 3 || typeof(T) == typeof(T4) && TypeIndex == 4 || typeof(T) == typeof(T5) && TypeIndex == 5 || typeof(T) == typeof(T6) && TypeIndex == 6 || typeof(T) == typeof(T7) && TypeIndex == 7)
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (obj is not Any<T1, T2, T3, T4, T5, T6, T7> other)
            return false;
    ...
    public static bool operator ==(Any<T1, T2, T3, T4, T5, T6, T7> left, Any<T1, T2, T3, T4, T5, T6, T7> right) => left.Equals(right);
    public static bool operator !=(Any<T1, T2, T3, T4, T5, T6, T7> left, Any<T1, T2, T3, T4, T5, T6, T7> right) => !left.Equals(right);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void TryMatch(Action<T1?>? case1 = null, Action<T2?>? case2 = null, Action<T3?>? case3 = null, Action<T4?>? case4 = null, Action<T5?>? case5 = null, Action<T6?>? case6 = null, Action<T7?>? case7 = null)
    {
        switch (this.TypeIndex)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T1 GetT1(out Any<T2, T3, T4, T5, T6, T7> remainder)
    {
        remainder = TypeIndex switch
        {
            2 => Any<T2, T3, T4, T5, T6, T7>.From((T2)Value!),
            3 => Any<T2, T3, T4, T5, T6, T7>.From((T3)Value!),
            4 => Any<T2, T3, T4, T5, T6, T7>.From((T4)Value!),
            5 => Any<T2, T3, T4, T5, T6, T7>.From((T5)Value!),
            6 => Any<T2, T3, T4, T5, T6, T7>.From((T6)Value!),
            7 => Any<T2, T3, T4, T5, T6, T7>.From((T7)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T2 GetT2(out Any<T1, T3, T4, T5, T6, T7> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T3, T4, T5, T6, T7>.From((T1)Value!),
            3 => Any<T1, T3, T4, T5, T6, T7>.From((T3)Value!),
            4 => Any<T1, T3, T4, T5, T6, T7>.From((T4)Value!),
            5 => Any<T1, T3, T4, T5, T6, T7>.From((T5)Value!),
            6 => Any<T1, T3, T4, T5, T6, T7>.From((T6)Value!),
            7 => Any<T1, T3, T4, T5, T6, T7>.From((T7)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T3 GetT3(out Any<T1, T2, T4, T5, T6, T7> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T2, T4, T5, T6, T7>.From((T1)Value!),
            2 => Any<T1, T2, T4, T5, T6, T7>.From((T2)Value!),
            4 => Any<T1, T2, T4, T5, T6, T7>.From((T4)Value!),
            5 => Any<T1, T2, T4, T5, T6, T7>.From((T5)Value!),
            6 => Any<T1, T2, T4, T5, T6, T7>.From((T6)Value!),
            7 => Any<T1, T2, T4, T5, T6, T7>.From((T7)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T4 GetT4(out Any<T1, T2, T3, T5, T6, T7> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T2, T3, T5, T6, T7>.From((T1)Value!),
            2 => Any<T1, T2, T3, T5, T6, T7>.From((T2)Value!),
            3 => Any<T1, T2, T3, T5, T6, T7>.From((T3)Value!),
            5 => Any<T1, T2, T3, T5, T6, T7>.From((T5)Value!),
            6 => Any<T1, T2, T3, T5, T6, T7>.From((T6)Value!),
            7 => Any<T1, T2, T3, T5, T6, T7>.From((T7)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T5 GetT5(out Any<T1, T2, T3, T4, T6, T7> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T2, T3, T4, T6, T7>.From((T1)Value!),
            2 => Any<T1, T2, T3, T4, T6, T7>.From((T2)Value!),
            3 => Any<T1, T2, T3, T4, T6, T7>.From((T3)Value!),
            4 => Any<T1, T2, T3, T4, T6, T7>.From((T4)Value!),
            6 => Any<T1, T2, T3, T4, T6, T7>.From((T6)Value!),
            7 => Any<T1, T2, T3, T4, T6, T7>.From((T7)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T6 GetT6(out Any<T1, T2, T3, T4, T5, T7> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T2, T3, T4, T5, T7>.From((T1)Value!),
            2 => Any<T1, T2, T3, T4, T5, T7>.From((T2)Value!),
            3 => Any<T1, T2, T3, T4, T5, T7>.From((T3)Value!),
            4 => Any<T1, T2, T3, T4, T5, T7>.From((T4)Value!),
            5 => Any<T1, T2, T3, T4, T5, T7>.From((T5)Value!),
            7 => Any<T1, T2, T3, T4, T5, T7>.From((T7)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T7 GetT7(out Any<T1, T2, T3, T4, T5, T6> remainder)
    {
        remainder = TypeIndex switch
        {
            1 => Any<T1, T2, T3, T4, T5, T6>.From((T1)Value!),
            2 => Any<T1, T2, T3, T4, T5, T6>.From((T2)Value!),
            3 => Any<T1, T2, T3, T4, T5, T6>.From((T3)Value!),
            4 => Any<T1, T2, T3, T4, T5, T6>.From((T4)Value!),
            5 => Any<T1, T2, T3, T4, T5, T6>.From((T5)Value!),
            6 => Any<T1, T2, T3, T4, T5, T6>.From((T6)Value!),
            _ => default
        };
        try
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT1(out T1? value, out Any<T2, T3, T4, T5, T6, T7> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T2, T3, T4, T5, T6, T7>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T2, T3, T4, T5, T6, T7>.From(t3);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = Any<T2, T3, T4, T5, T6, T7>.From(t4);
        else if (TypeIndex == 5 && Value is T5 t5)
            remainder = Any<T2, T3, T4, T5, T6, T7>.From(t5);
        else if (TypeIndex == 6 && Value is T6 t6)
            remainder = Any<T2, T3, T4, T5, T6, T7>.From(t6);
        else if (TypeIndex == 7 && Value is T7 t7)
            remainder = Any<T2, T3, T4, T5, T6, T7>.From(t7);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT2(out T2? value, out Any<T1, T3, T4, T5, T6, T7> remainder)
    {
        value = default;
        remainder = default;
        if (TypeIndex == 2 && Value is T2 t2)
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T3, T4, T5, T6, T7>.From(t1);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T1, T3, T4, T5, T6, T7>.From(t3);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = Any<T1, T3, T4, T5, T6, T7>.From(t4);
        else if (TypeIndex == 5 && Value is T5 t5)
            remainder = Any<T1, T3, T4, T5, T6, T7>.From(t5);
        else if (TypeIndex == 6 && Value is T6 t6)
            remainder = Any<T1, T3, T4, T5, T6, T7>.From(t6);
        else if (TypeIndex == 7 && Value is T7 t7)
            remainder = Any<T1, T3, T4, T5, T6, T7>.From(t7);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT3(out T3? value, out Any<T1, T2, T4, T5, T6, T7> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T2, T4, T5, T6, T7>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T1, T2, T4, T5, T6, T7>.From(t2);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = Any<T1, T2, T4, T5, T6, T7>.From(t4);
        else if (TypeIndex == 5 && Value is T5 t5)
            remainder = Any<T1, T2, T4, T5, T6, T7>.From(t5);
        else if (TypeIndex == 6 && Value is T6 t6)
            remainder = Any<T1, T2, T4, T5, T6, T7>.From(t6);
        else if (TypeIndex == 7 && Value is T7 t7)
            remainder = Any<T1, T2, T4, T5, T6, T7>.From(t7);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT4(out T4? value, out Any<T1, T2, T3, T5, T6, T7> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T2, T3, T5, T6, T7>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T1, T2, T3, T5, T6, T7>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T1, T2, T3, T5, T6, T7>.From(t3);
        else if (TypeIndex == 5 && Value is T5 t5)
            remainder = Any<T1, T2, T3, T5, T6, T7>.From(t5);
        else if (TypeIndex == 6 && Value is T6 t6)
            remainder = Any<T1, T2, T3, T5, T6, T7>.From(t6);
        else if (TypeIndex == 7 && Value is T7 t7)
            remainder = Any<T1, T2, T3, T5, T6, T7>.From(t7);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT5(out T5? value, out Any<T1, T2, T3, T4, T6, T7> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T2, T3, T4, T6, T7>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T1, T2, T3, T4, T6, T7>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T1, T2, T3, T4, T6, T7>.From(t3);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = Any<T1, T2, T3, T4, T6, T7>.From(t4);
        else if (TypeIndex == 6 && Value is T6 t6)
            remainder = Any<T1, T2, T3, T4, T6, T7>.From(t6);
        else if (TypeIndex == 7 && Value is T7 t7)
            remainder = Any<T1, T2, T3, T4, T6, T7>.From(t7);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT6(out T6? value, out Any<T1, T2, T3, T4, T5, T7> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T2, T3, T4, T5, T7>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T1, T2, T3, T4, T5, T7>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T1, T2, T3, T4, T5, T7>.From(t3);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = Any<T1, T2, T3, T4, T5, T7>.From(t4);
        else if (TypeIndex == 5 && Value is T5 t5)
            remainder = Any<T1, T2, T3, T4, T5, T7>.From(t5);
        else if (TypeIndex == 7 && Value is T7 t7)
            remainder = Any<T1, T2, T3, T4, T5, T7>.From(t7);
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetT7(out T7? value, out Any<T1, T2, T3, T4, T5, T6> remainder)
    {
        value = default;
        remainder = default;
        ...
        if (TypeIndex == 1 && Value is T1 t1)
            remainder = Any<T1, T2, T3, T4, T5, T6>.From(t1);
        else if (TypeIndex == 2 && Value is T2 t2)
            remainder = Any<T1, T2, T3, T4, T5, T6>.From(t2);
        else if (TypeIndex == 3 && Value is T3 t3)
            remainder = Any<T1, T2, T3, T4, T5, T6>.From(t3);
        else if (TypeIndex == 4 && Value is T4 t4)
            remainder = Any<T1, T2, T3, T4, T5, T6>.From(t4);
        else if (TypeIndex == 5 && Value is T5 t5)
            remainder = Any<T1, T2, T3, T4, T5, T6>.From(t5);
        else if (TypeIndex == 6 && Value is T6 t6)
            remainder = Any<T1, T2, T3, T4, T5, T6>.From(t6);
        return false;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Any<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7> MapAny<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>(Func<T1, TResult1> map1, Func<T2, TResult2> map2, Func<T3, TResult3> map3, Func<T4, TResult4> map4, Func<T5, TResult5> map5, Func<T6, TResult6> map6, Func<T7, TResult7> map7)
    {
        return TypeIndex switch
        {
            1when Value is T1 v1 => map1(v1),
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TResult MapWithContext<TResult>(Func<Any<T1, T2, T3, T4, T5, T6, T7>, T1, TResult> map1, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T2, TResult> map2, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T3, TResult> map3, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T4, TResult> map4, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T5, TResult> map5, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T6, TResult> map6, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T7, TResult> map7)
    {
        return TypeIndex switch
        {
    ...
    /// </summary>
    public TResult SelectWithContext<TResult>(Func<Any<T1, T2, T3, T4, T5, T6, T7>, T1, TResult> selector1, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T2, TResult> selector2, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T3, TResult> selector3, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T4, TResult> selector4, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T5, TResult> selector5, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T6, TResult> selector6, Func<Any<T1, T2, T3, T4, T5, T6, T7>, T7, TResult> selector7)
    {
        return TypeIndex switch
        {
