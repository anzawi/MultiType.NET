    ...
    public static void EmitSelectMethods(StringBuilder sb, int arity)
{
    ...
    sb.AppendLine($$"""
        /// <summary>
        /// Projects the union value into a new form using the specified selector functions.
        /// </summary>
        public TResult Select<TResult>({{selectors}})
        {
            ...
            {
                {{selectCases}},
                _ => throw new InvalidUnionStateException("Union is not in a valid state for selection")
            };
        }
    """);
    ...
    sb.AppendLine($$"""
        /// <summary>
        /// Projects the union value using selector functions, or returns a fallback default.
        /// </summary>
    ...
    sb.AppendLine($$"""
        /// <summary>
        /// Attempts to project the union value using selector functions.
    ...
    var contextSelectors = string.Join(", ",
        Enumerable.Range(1, arity).Select(i => $"Func<Union<{string.Join(", ", Enumerable.Range(1, arity).Select(j => $"T{j}"))}>, T{i}, TResult> selector{i}"));
    ...
    sb.AppendLine($$"""
        /// <summary>
        /// Projects the union value with access to full context.
        /// </summary>
    ...
    sb.AppendLine($$"""
        /// <summary>
        /// Conditionally maps union value if predicate passes, otherwise returns default.
        /// </summary>
    ...
    sb.AppendLine($$"""
        /// <summary>
        /// Asynchronously projects the union value using the specified async selector functions.
        /// </summary>
    ...
    sb.AppendLine($$"""
        /// <summary>
        /// Asynchronously projects the union value, or returns fallback default.
        /// </summary>
